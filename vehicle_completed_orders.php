...
<?php require_login()?>
    ...
    <section class="content">
      ...
      <?php if($session->is_logged_in() && $_SESSION['user_role'] === "Vehicle") {
                $vid = $session->user_id;
      ?>

        <div class="row">
              <?php $vehicle = User::find_by_id($vid);
              
              $sql = "SELECT * FROM `vehicle` WHERE user_id = $vid";
              $vcompanys = Vehicle::find_by_sql($sql);
              foreach($vcompanys as $vcompany){
                  $cvehicle_id = $vcompany->id
              ?>
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i>Driver Name: <?php echo $vcompany->name ?>
                    <?php } ?>
                  </h4>
                </div>
                <!-- /.col -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Vehicle Order Details</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php 
                    ...
                    ON booking_details.order_id = q1.id) AS l1 WHERE isCompleted = 1 AND vehicle_id = $cvehicle_id
                    ";
