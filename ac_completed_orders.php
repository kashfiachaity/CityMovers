...
<?php require_login() ?>
    ...
    <section class="content">
      ...
      <?php if($session->is_logged_in() && $_SESSION['user_role'] === "AC") {
                $aid = $session->user_id;
                
      ?>

              <div class="row">
              <?php $vehicle = User::find_by_id($aid);
              
              $sql = "SELECT * FROM `aircondition` WHERE user_id = $aid";
              $vcompanys = Aircondition::find_by_sql($sql);
              foreach($vcompanys as $vcompany){
                  $cac_id = $vcompany->id
              ?>
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i>Company Name: <?php echo $vcompany->company_name?>
                    <?php } ?>
                  </h4>
                </div>
                <!-- /.col -->
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  From
                  <address>
                    <strong>Owner Name:<?php echo $vehicle->name?></strong><br>
                    Phone:<?php echo $vehicle->phone?><br>
                    Email: <?php echo $vehicle->email?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Air Condition Worker Hired Details</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php 
                    ...
                    ON booking_details.order_id = q1.id) AS l1 WHERE isCompleted = 1 AND ac_id = $cac_id
                    ";
