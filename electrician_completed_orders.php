...
<?php require_login() ?>
    ...
    <section class="content">
      ...
      <?php if($session->is_logged_in() && $_SESSION['user_role'] === "Electrician") {
                $eid = $session->user_id;
                
      ?>

              <div class="row">
              <?php $electrician = User::find_by_id($eid);
              
              $sql = "SELECT * FROM `electrician` WHERE user_id = $eid";
              $ecompanys = Electrician::find_by_sql($sql);
              foreach($ecompanys as $company){
                $celect_id = $company->id
              ?>
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i>Company Name: <?php echo $company->company_name?>
                    <?php } ?>
                  </h4>
                </div>
                <!-- /.col -->
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  From
                  <address>
                    <strong>Owner Name:<?php echo $electrician->name?></strong><br>
                    Phone:<?php echo $electrician->phone?><br>
                    Email: <?php echo $electrician->email?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Electrician Hired Details</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php 
                    ...
                    ON booking_details.order_id = q1.id) AS l1 WHERE isCompleted = 1 AND electrician_id = $celect_id
                    ";
