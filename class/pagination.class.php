...
class Pagination{
    ...
    public function previous_link($url="") {
        ...
        if($this->previous_page() != false) {
            $link .= "<a style=\"margin-right:5px;\"  href=\"{$url}?page={$this->previous_page()}\">";
    ...
    public function next_link($url="") {
        ...
        if($this->next_page() != false) {
            $link .= "<a style=\"margin-left:5px;\" href=\"{$url}?page={$this->next_page()}\">";
            $link .= "Next &raquo;</a>";
        }
        return $link;
    }
    ...
    public function number_links($url="") {
        ...
        for($i=1; $i <= $this->total_pages(); $i++) {
            if($i == $this->current_page) {
                ...
                $output .= "<a style=\"margin:0px 5px 0px 5px;\" href=\"{$url}?page={$i}\">{$i}</a>";
            }
        }
        return $output;
    }
