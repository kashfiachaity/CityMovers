              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php 
                    ...
                    ON booking_details.order_id = q1.id) AS l1 WHERE isCompleted = 0 AND vehicle_id = $cvehicle_id
                    ";
